function loadFooter(pathToRoot = './') {
    const footer = `
    <footer style="backdrop-filter: blur(80px); -webkit-backdrop-filter: blur(80px); box-shadow: 0 8px 48px 0 rgba(255,255,255,0.18), 0 4px 32px 0 rgba(0,0,0,0.12); background: rgba(0,100,56,0.8);" class="relative overflow-hidden text-white animate-fade-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div class="col-span-1">
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="https://nep.rea.gov.ng/" class="hover:text-gray-200 footer-link inline-block glow-text">Visit NEP</a></li>
                    </ul>
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <address class="not-italic space-y-4 glow-text">
                        ...
                        <p class="mt-8">
                            <a href="mailto:nep@rea.gov.ng" class="hover:text-gray-200 footer-link inline-block glow-text">nep@rea.gov.ng</a>
                        </p>
                        <p>
