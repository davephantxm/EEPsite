    ...
    <footer class="bg-primary-green relative overflow-hidden text-white animate-fade-in">
        ...
        <div class="relative container mx-auto px-4 py-16">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <!-- Social Links -->
                <div class="col-span-1">
                    <h4 class="text-lg font-semibold mb-6">Social</h4>
                    <ul class="space-y-4">
                        <li>
                            <a href="https://www.linkedin.com/company/rural-electrification-agency-of-nigeria/" class="flex items-center hover:text-gray-200 footer-link">
                        ...
                        <li>
                            <a href="https://x.com/TheREANigeria" class="flex items-center hover:text-gray-200 footer-link">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <a href="https://www.instagram.com/realreanigeria/" class="flex items-center hover:text-gray-200 footer-link">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <a href="https://www.facebook.com/REANigeria" class="flex items-center hover:text-gray-200 footer-link">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
